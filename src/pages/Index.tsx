...
const translations = {
  en: {
    ...
    lintensityDesc: "Current Ambient Light captured in the area",
    light: "Light Mode",
    dark: "Dark Mode",
  ...
  hi: {
    ...
    lintensityDesc: "क्षेत्र में वर्तमान आस-पास की रोशनी कैप्चर की गई",
    light: "लाइट मोड",
    dark: "डार्क मोड",
  ...
  mr: {
    ...
    lintensityDesc: "परिसरात सध्याचा आसपासचा उजेड कैप्चर केला गेला",
    light: "लाइट मोड",
    dark: "गडद मोड",
  ...
  const { data, isInitialSync, isVisualOffline } = useMemo(() => {
    ...
    if (liveData?.timestamp) {
      ...
      heartbeatOffline = secondsSinceUpdate > 2000;
    }
